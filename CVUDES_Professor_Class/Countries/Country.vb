...
<Serializable()> Public Class Country
    ...
    <Tracing.PropertyDescriptor("Indicative")> _
    Public Property Indicative() As String
        Get
            Return _Indicative
        End Get
        Set(ByVal value As String)
    ...
    <Tracing.PropertyDescriptor("Area")> _
