...
Public NotInheritable Class ModalityHandler

    Private Sub New()
    End Sub

    Public Shared Function Read(ByVal modalityId As Guid) As Modality
        Dim objModality As Modality = New Modality
        Dim db As Database = DatabaseFactory.CreateDatabase("ConexionDB")
        Dim dbCommand As DbCommand = db.GetStoredProcCommand("Modality_Read")
        db.AddInParameter(dbCommand, "ModalityId", DbType.Guid, modalityId)
        Using dataReader As IDataReader = db.ExecuteReader(dbCommand)
            If (dataReader.Read()) Then
                With objModality
                    If Not Convert.IsDBNull(dataReader("ModalityId")) Then .ModalityId = dataReader("ModalityId")
    ...
    Public Shared Function Create(ByVal objModality As Modality) As Boolean
        Dim returnValue As Boolean = False
        Dim db As Database = DatabaseFactory.CreateDatabase("ConexionDB")
        Dim dbCommand As DbCommand = db.GetStoredProcCommand("Modality_Create")
        With objModality
            db.AddInParameter(dbCommand, "ModalityId", DbType.Guid, .ModalityId)
    ...
    Public Shared Function Update(ByVal objModality As Modality) As Boolean
        Dim returnValue As Boolean = False
        Dim db As Database = DatabaseFactory.CreateDatabase("ConexionDB")
        Dim dbCommand As DbCommand = db.GetStoredProcCommand("Modality_Update")
        With objModality
            db.AddInParameter(dbCommand, "ModalityId", DbType.Guid, .ModalityId)
            db.AddInParameter(dbCommand, "Code", DbType.String, .Code)
            db.AddInParameter(dbCommand, "Description", DbType.String, .Description)
    ...
    Public Shared Function Delete(ByVal modalityId As Guid) As Boolean
        Dim returnValue As Boolean = False
        Dim db As Database = DatabaseFactory.CreateDatabase("ConexionDB")
        Dim dbCommand As DbCommand = db.GetStoredProcCommand("Modality_Delete")
        db.AddInParameter(dbCommand, "ModalityId", DbType.Guid, modalityId)
        db.AddOutParameter(dbCommand, "ReturnValue", DbType.Boolean, 0)
        db.ExecuteNonQuery(dbCommand)
        returnValue = db.GetParameterValue(dbCommand, "ReturnValue")
    ...
    Public Shared Function MoveUp(ByVal modalityId As Guid) As Boolean
        Dim returnValue As Boolean = False
        Dim db As Database = DatabaseFactory.CreateDatabase("ConexionDB")
        Dim dbCommand As DbCommand = db.GetStoredProcCommand("Modality_MoveUp")
        db.AddInParameter(dbCommand, "ModalityId", DbType.Guid, modalityId)
        db.AddOutParameter(dbCommand, "ReturnValue", DbType.Boolean, 0)
        db.ExecuteNonQuery(dbCommand)
        returnValue = db.GetParameterValue(dbCommand, "ReturnValue")
    ...
    Public Shared Function MoveDown(ByVal modalityId As Guid) As Boolean
        Dim returnValue As Boolean = False
        Dim db As Database = DatabaseFactory.CreateDatabase("ConexionDB")
        Dim dbCommand As DbCommand = db.GetStoredProcCommand("Modality_MoveDown")
        db.AddInParameter(dbCommand, "ModalityId", DbType.Guid, modalityId)
        db.AddOutParameter(dbCommand, "ReturnValue", DbType.Boolean, 0)
        db.ExecuteNonQuery(dbCommand)
        returnValue = db.GetParameterValue(dbCommand, "ReturnValue")
