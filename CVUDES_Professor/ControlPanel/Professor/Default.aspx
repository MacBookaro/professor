<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/_MasterPages/Default.Master" CodeBehind="Default.aspx.vb" Inherits="CVUDES_Professor.ProfessorDefaultpage" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="height: 295px;">
        <tr>
            <td id="MainCommonOptions" class="MainContainer" style="width: 440px;">
                <asp:Label ID="Label1" runat="server" Text="<%$ Resources: Tags, tagProfessorOptions %>" CssClass="MainMenuTitle"></asp:Label>
